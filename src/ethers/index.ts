const transakExecuterAbi = require('./abi/ABItransakexecuter.json')
...
export const createAsset = (signer: any) => {
    let contract = new Contract("0x0E9539455944BE8a307bc43B0a046613a1aD6732", transakExecuterAbi, signer)
